...
console.log("Challenge 14 (Strict Non-Equality):", x !== y); 
console.log("Challenge 14 (Strict Non-Equality):", x !== x); 

// Challenge 15: Perform 2 Less than Comparison operations, in which one should return true and one should return false.
console.log("Challenge 15 (Less Than):", x < y); 
...
console.log("Challenge 17 (Less Than or Equal To):", x <= z); 
